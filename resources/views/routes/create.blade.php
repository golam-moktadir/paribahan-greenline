            ...
            <form method="POST" action="{{ route($resource . '.store') }}" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="w-full">
                        ...
                        <input type="hidden" name="return_routes_id" id="return_routes_id">
                    </div>
                    <div class="flex flex-wrap items-end gap-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="w-full">
                        <label for="route_departure_desc" class="block text-sm font-medium text-gray-700 mb-1">Description</label>
                        <textarea name="route_departure_desc" id="route_departure_desc" rows="4"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="w-full">
                        ...
                        <input type="text" name="route_total_bus" id="route_total_bus" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm" value="0">
                ...
                $('#city_id').each(function () {
                    if (city_id.includes($(this).val()) == false) {
                        if($(this).val() != ""){
                            ...
                            $("#routes_id").val(city_id.join(" - "));
                            $("#return_route").val(city_name.reverse().join(" - "));
                            $("#return_routes_id").val(city_id.reverse().join(" - "));
                            $('#route_name').focus();
                            $("#city_id").val("");
                        }
                    }
