...
@section('content')
    <div class="form-container">
        <div class="card">
            <h1 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">Add New Booth</h1>
            @if ($errors->any())
                ...
                <div class="grid grid-cols-1 gap-4 text-left">
                    ...
                    <div>
                        <label for="booth_code" class="block text-sm font-medium text-gray-700 mb-1">Booth Code <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="booth_code" id="booth_code" value="{{ $booth_code + 1 }}"
                            class="w-full px-3 py-1 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                    ...
                    <div>
                        <label for="station_id" class="block text-sm font-medium text-gray-700 mb-1">Station <span
                                class="text-red-500">*</span></label>
                        <select name="station_id" id="station_id"
                            ...
                            @if(old('city_id'))
                                @foreach($stations as $station)
                                    @if($station->city_id == old('city_id'))
                    ...
                    <div>
                        <label for="booth_man_in_charge_employee_id"
                            class="block text-sm font-medium text-gray-700 mb-1">Man in
                            Charge</label>
                    ...
                    <div>
                        <label for="booth_address" class="block text-sm font-medium text-gray-700 mb-1">Booth Address <span
                                class="text-red-500">*</span></label>
