...
@section('title', 'Booth Description')
        ...
        <div class="data-table-container bg-white shadow rounded-lg overflow-hidden">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between p-1 border-b border-gray-200 gap-4">
                <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                    ...
                    <x-datatable.search-input id="booth_name" placeholder="Search By Booth Name" icon="fas fa-search" />
                </div>
            ...
            <div class="overflow-x-auto mt-1">
                <x-datatable.data-table id="boothsTable" :columns="[
            [
                'data' => null,
                'render' => 'rowIndex',
                'orderable' => false,
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const table = $('#boothsTable').DataTable({
                serverSide: true,
                ajax: {
            ...
            let searchTimeout;
            $('#station_name, #booth_name').on('keyup', function () {
