...
@section('content')
    <div class="container mx-auto">
        ...
        <div class="data-table-container">
            ...
            <x-datatable.data-table id="guidesTable" :columns="[
                [
                    'data' => null,
                    'render' => 'rowIndex',
                    'orderable' => false,
...
@push('scripts')
    ...
    <script>
        function setupTable() {
            ...
            let searchTimeout;
            $('#searchName, #searchIdNo, #searchPhone').on('keyup', function() {
        ...
        async function confirmDelete(guideId) {
            try {
                await loadSweetAlert();

                const result = await Swal.fire({
                    title: 'Are you sure?',
                    text: 'This action will permanently delete the guide. This cannot be undone!',
                    icon: 'warning',
                ...
                if (result.isConfirmed) {
                    const form = document.getElementById(`delete-guide-form-${guideId}`);
                    if (form) {
                        form.submit();
                    } else {
                        console.error(`Form with ID delete-guide-form-${guideId} not found`);
                        await Swal.fire({
                            title: 'Error',
