...
@section('content')
    <div class="form-container">
        <div class="card">
            <h1 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">Add New Guide</h1>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <x-form.input-group name="reference" label="Reference" type="text" minlength="4"
                                maxlength="100" required hint="e.g., Jane Smith" :value="old('reference')" />
                        </div>
                        <!-- Addresses -->
                        <div class="mt-2">
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            ['avatar_url', 'nid_attachment', 'insurance_attachment'].forEach(id =>
